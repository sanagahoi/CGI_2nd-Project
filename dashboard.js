...
const months = apiData.dasbhoardPage.latestHits.months;
const latestHits = apiData.dasbhoardPage.latestHits.latest;
const popularHits = apiData.dasbhoardPage.latestHits.popular;
const featured = apiData.dasbhoardPage.latestHits.featured;
...
const PerformanceColor = Object.keys(apiData.dasbhoardPage.performance);
const PerformanceVal = Object.values(apiData.dasbhoardPage.performance);
...
const storeAvailable = Object.values(apiData.dasbhoardPage.storage);
...
apiData.dasbhoardPage.notifications.forEach(notification => {
...
// const orders = apiData.dasbhoardPage.orders;
...
//           <td class= "ord"> <div class="tm-status-circle"><div class="sts"></div>${order.status}
//           </div></td>
...
//       const statusCircle = document.querySelector('.tm-status-circle div');
